...
![](https://pica.zhimg.com/v2-310046d2ded45ca99cb74d992a94a51e_1440w.jpg)
...
上面的代码三大编译器都可以编译通过，并且完全符合 C++ 标准。这就给了我们操作的空间，我们可以在实例化类模板的同时实例化其内部定义的友元函数，从而给其他位置的函数声明添加定义。这种技术也被叫做**友元注入 (friend injection)**。
