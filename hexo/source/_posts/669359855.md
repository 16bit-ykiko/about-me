...
但是更多时候还是语言内建的特性使用的更加方便一些，使用外部的代码生成器会让编译流程变得复杂一些。然而也有一些语言，将这个特性作为了语言内置的特性之一，比如`C#`的[code generation](https:https%3A//learn.microsoft.com/en-us/dotnet/csharp/roslyn-sdk/source-generators-overview)。
