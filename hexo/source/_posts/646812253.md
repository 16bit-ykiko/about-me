...
相关的代码仍然放 [Compiler Explorer](https:https%3A//godbolt.org/z/7W7c7P8n1) 上。为了防止链接失效，同样放在 [Github](https:https%3A//github.com/16bit-ykiko/blog/blob/main/code/stmp-polymorphic.cpp)。 
